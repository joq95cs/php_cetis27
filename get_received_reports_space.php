...
class GetReceivedReportsSpace {
    ...
    public function get() {
        ...
        $sql = 'SELECT * FROM reportes WHERE espacio = ? AND estatus = "Pendiente"';
...
$getReceivedReportsSpace = new GetReceivedReportsSpace($received_espacio);
$reports = $getReceivedReportsSpace->get();
