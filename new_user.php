...
if(!$received_asunto or !$received_descripcion or !$received_foto or !$received_usuario or !$received_categoria or !$received_espacio) {
...
class NewReport {
    ...
    public function __construct($asunto, $descripcion, $foto, $usuario, $categoria, $espacio) { //El constructor recibe los campos del reporte
    ...
    public function add() { //Método público encargado de agregar un nuevo registro a la tabla de reportes
        ...
        $statement->bind_param('sssiii', $this->asunto, $this->descripcion, $this->foto, $this->usuario, $this->categoria, $this->espacio); //Se ligan los parámetros para la consulta preparada, los cuales corresponden a los campos de clase privados
        $statement->execute();
...
$newReport = new NewReport($received_asunto, $received_descripcion, $received_foto, $received_usuario, $received_categoria, $received_espacio);
